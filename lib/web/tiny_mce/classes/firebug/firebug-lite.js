      ...
      if (!fe.popupWin) {
        ...
        if(!fe.popupWin) {
          ...
          if (scriptPath) {
            ...
            alert("Unable to detect the following scripts \"" + fe.liteFilename +
                  "\" ... if the scripts has been renamed then please set the value of firebug.env.liteFilename to reflect this change");
            fe.popupWin.close();
            fe.popupWin=null;
          }
        }
